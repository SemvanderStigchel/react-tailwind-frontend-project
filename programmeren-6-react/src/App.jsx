                    ...
                    <div
                        ...
                        <div className="order-1 md:order-2">
                            <Link className="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl "
                               to={'/'}>
                                <svg className={'fill-current text-gray-800 mr-2'} xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                    <path
                        ...
                        <div className="order-2 md:order-3 flex items-center" id="nav-content">
                            ...
                            <Link to={'/notes/create'} className={'bg-gray-600 border border-gray-600 text-white inline-block no-underline hover:bg-white hover:text-black hover:underline py-2 px-4'}>
                                Create Note
                            </Link>
                        ...
                        <div className="w-full mx-auto flex flex-wrap">
                            <div className="flex w-full lg:w-1/2 ">
                                <div className="px-3 md:px-0">
                                    ...
                                    <p className="py-4">
                                        "Welcome to NoteApp's Notes Hub! Unleash your creativity and organization
                                        with personalized notes in this digital haven. NoteApp believes that every
                                        thought is a seed
                                        waiting to bloom, and this platform is the fertile ground for your ideas to
                                        flourish. Start jotting down your musings, plans, and inspirations now, and let
                                        the journey of self-expression begin. Happy note-taking!"
                                    </p>
                                </div>
                            </div>
